...
export const updateLayout = ({ page, ...payload }) =>
  privateInstance.put(`/v1/admin/customize/layout/${page}`, payload);
export const updateLayoutSection = ({ page, sectionId, ...payload }) =>
  privateInstance.put(`/v1/admin/customize/layout/${page}/sections/${sectionId}`, { ...payload });
